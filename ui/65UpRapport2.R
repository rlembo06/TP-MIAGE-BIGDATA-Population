fluidRow(
  ...
  titlePanel("Rapport sur le vieillissement de la population européenne"),
  ...
  box(title = "Récupération des données",width = 12,
      ...
      tags$img("[IMG] image recupDonnées", src=""), br(),
      ...
      tags$img("[IMG] image Tableau3", src=""), br(),
  ...
  box(title = "Vérification des hypothèses",width = 12,
      ...
      tags$img("[IMG] image zstat65", src=""), br(),
      
      tags$b("Vérification avec R Studio :"),
      tags$img("[IMG] image zstat65R", src=""), br(),
      ...
      tags$img("[IMG] image alpha65", src=""), br()
      ),
  ...
  box(title = "Conclusion", width = 12,
      ...
      De plus, plus la statistique de test est grande plus les deux échantillons sont différents, nous pouvons donc conclure que la population européenne est beaucoup plus âgée de 2011 à 2017 que sur les cinquante années précédentes.
             ")
      )
